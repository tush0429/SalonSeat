        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    ...
                    $connect = mysqli_connect('localhost', 'root', '', 'salonseat');
                    $select = "SELECT * FROM `appointment` WHERE ApptUserPhno=$phoneNo ORDER BY appointmnetNo DESC";
                    $response =  mysqli_query($connect, $select);
                    ...
                    while ($row = mysqli_fetch_array($response)) {
                        echo "<div class='card mb-5 animated zoomIn' style='animation-delay:1.2s;'>
                            ...
                            <div class='card-body'>
                                <p class='card-title'>Appointment Status: $row[5]</p>
                                <p class='card-text'>Bill Amount: &#x20B9; $row[3]</p>
                                <a href='rdetails.php?a=$row[0]' class='btn btn-primary'>View Details</a>
                            </div>
                        </div>";
                    }
