...
<body>
    ...
    <div>
        ...
        font-size: 32px; font-weight:bolder; color:#fff;">
                <img src="./Source/hairdresser (1).png" width="50" height="40" style="margin-top:-10px;" /> SalonSeat</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="phpCode/redirect.php" style="text-decoration:none;">
                ...
                <li class="nav-item active">
                    <a href="" class="sizo nav-link">
                        <div class="card animated rotateInUpLeft" style="width: 7rem; padding:10px;  border-radius: 15px; animation-delay: 0.8s; background:#f1f1f1 ;  align-content:center;">
                            <img src="Source/hair.png" width="40" height="50" style="padding:5px;" class="card-img-top" alt="...">
                ...
                <li class="nav-item">
                    <a href="" class="sizo nav-link">
                        <div class="card animated rotateInUpLeft" style="width: 8rem; padding:10px;border-radius: 15px; background:#f1f1f1 ; animation-delay: 1.0s; align-content:center;">
                            <img src="Source/girlHair.png" width="40" height="50" style="padding:5px;" class="card-img-top" alt="...">
                            <div class="card-body" style="margin-bottom:-20px;margin-top:-20px;">
                ...
                <li class="nav-item">
                    <a href="" class="sizo nav-link">
                        <div class="card animated rotateInUpLeft" style="width: 7rem; padding:10px; border-radius: 15px; background:#f1f1f1 ; animation-delay: 1.3s; align-content:center;">
                            <img src="Source/hairwash.png" width="40" height="50" style="padding:5px;" class="card-img-top" alt="...">
                            <div class="card-body" style="margin-bottom:-20px;margin-top:-20px;">
                ...
                <li class="nav-item">
                    <a href="" class="sizo nav-link">
                        <div class="card animated rotateInUpLeft" style="width: 8rem; padding:10px; border-radius: 15px; background:#f1f1f1 ; animation-delay: 1.6s; align-content:center;">
                            <img src="Source/makeup.png" width="40" height="50" style="padding:5px;" class="card-img-top" alt="...">
                            <div class="card-body" style="margin-bottom:-20px;margin-top:-20px;">
                            ...
                            <div class='card' style='width: 18rem; border-radius: 15px;'>
                                ...
                                <div class='card-body'>
                                    ...
                                    <div class='row'>
                                        ...
                                        <button  type='submit' class='btn btn-success'  formaction='phpCode/details.php' name='add'>View
            ...
            <div class="owl-carousel owl-theme">
                ...
                while ($row = mysqli_fetch_array($response)) {
                    ...
                    echo "<div class='col-md 3'>
                      <div class='card' style='width: 18rem; border-radius: 15px;'>
                         <a href='./phpCode/viewphpOffer.php?a=$row[1]&b=Male'>
        ...
        <div class="row mt-1 mb-5">
            <div class="owl-carousel owl-theme">
                ...
                while ($row = mysqli_fetch_array($response)) {
                    ...
                    echo "<div class='col-md 3'>
                      <div class='card' style='width: 18rem; border-radius: 15px;'>
                         <a href='./phpCode/viewphpOffer.php?a=$row[1]&b=Female'>
                         <img src='$row[2]' style='padding:0px; border-radius: 15px;' class='card-img-top'>
                    </a>
